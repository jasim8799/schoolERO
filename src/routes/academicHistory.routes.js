...
} = require('../controllers/academicHistory.controller.js');
...
router.get('/student/:studentId/session/:sessionId/summary', authenticate, enforceSchoolIsolation, requireRole(USER_ROLES.PRINCIPAL, USER_ROLES.OPERATOR, USER_ROLES.TEACHER, USER_ROLES.STUDENT, USER_ROLES.PARENT), getStudentSessionSummary);
