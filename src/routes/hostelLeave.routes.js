...
const { createLeave, approveLeave, getLeaves, getHostelFees, getAllLeaves } = require('../controllers/hostelLeave.controller.js');
...
router.put('/approve/:id', authenticate, enforceSchoolIsolation, requireRole(USER_ROLES.PRINCIPAL, USER_ROLES.OPERATOR), approveLeave);
router.get('/leaves', authenticate, enforceSchoolIsolation, requireRole(USER_ROLES.PRINCIPAL, USER_ROLES.OPERATOR), getAllLeaves);
